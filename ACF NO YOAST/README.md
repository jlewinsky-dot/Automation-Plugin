...
Payload (example):
```bash
curl -X POST "https://example.com/wp-json/automation/v1/push" \
  -H "Content-Type: application/json" \
  -H "Authorization: Bearer <token>" \
  -d '{
    "post_id": 123,
    "title": "Automation Landing Page",
    "slug": "automation-landing",
    "status": "publish",
    "set_template": true,
    "acf": {
      "heading_home": "Always-On Automation",
      "phone_number": "(555) 123-4567",
      "meta_description": "Local experts delivering automation services."
    },
    "meta_title": "Automation Experts Near You"
  }'
```
